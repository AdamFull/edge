...
int edge_main(edge::PlatformLayout* platform_layout) {
	...
	const edge::PlatformContextCreateInfo platform_context_create_info = {
		.alloc = &allocator,
	...
	const edge::WindowCreateInfo window_create_info = {
		.title = "Window",
		.mode = edge::WindowMode::Default,
		.resizable = true,
		.vsync_mode = edge::WindowVsyncMode::Off,
		.width = 1280,
		.height = 720
	};
	...
	const edge::gfx::ContextCreateInfo gfx_cteate_info = {
		.alloc = &allocator,
	...
	const edge::gfx::QueueRequest queue_request = {
		.required_caps = edge::gfx::QUEUE_CAPS_GRAPHICS | edge::gfx::QUEUE_CAPS_COMPUTE | edge::gfx::QUEUE_CAPS_TRANSFER | edge::gfx::QUEUE_CAPS_PRESENT,
		.preferred_caps = edge::gfx::QUEUE_CAPS_NONE,
		.strategy = edge::gfx::QUEUE_SELECTION_STRATEGY_PREFER_DEDICATED,
	...
	const edge::gfx::RendererCreateInfo renderer_create_info = {
		.alloc = &allocator,
	...
	const edge::ImGuiLayerInitInfo imgui_init_info = {
	...
	const edge::gfx::ImGuiRendererCreateInfo imgui_renderer_create_info = {
