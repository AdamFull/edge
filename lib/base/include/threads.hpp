...
#error "Unsupported platform"
	...
	ThreadResult thread_set_affinity(Thread& thr, i32 core_id, bool prefer_physical = true);
	ThreadResult thread_set_affinity_ex(Thread& thr, CpuInfo* cpu_info, i32 cpu_count, i32 core_id, bool prefer_physical = true);
