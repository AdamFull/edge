...
constexpr ImGuiKey translate_gamepad_button(PadBtn code) {
  ...
  case PadBtn::BumperLeft:
    return ImGuiKey_GamepadL1;
  case PadBtn::BumperRight:
  ...
  case PadBtn::Guide:
    return ImGuiKey_None; // ImGui doesnt have a guide button
  case PadBtn::ThumbLeft:
    return ImGuiKey_GamepadL3;
  case PadBtn::ThumbRight:
    return ImGuiKey_GamepadR3;
  case PadBtn::DpadUp:
    return ImGuiKey_GamepadDpadUp;
  case PadBtn::DpadRight:
    return ImGuiKey_GamepadDpadRight;
  case PadBtn::DpadDown:
    return ImGuiKey_GamepadDpadDown;
  case PadBtn::DpadLeft:
...
struct ImGuiInputListener final : InputSystem::IListener {
  ...
  void on_axis_change(NotNull<const InputSystem *> input_system,
                      DeviceType device, usize button, glm::vec3 cur,
                      glm::vec3 prev) override {
    ImGuiIO &io = ImGui::GetIO();
...
void ImGuiLayer::on_frame_end() { ImGui::Render(); }
} // namespace edge